...
const UsersData = ( {
  ...
  /*
  - Написати функцію що повератє масив імен усіх користувачів у форматі "John, Smith" ("firstName, lastName")
  - Написати функцію що повератє список користувачів з правильним віком (age) на 2023 рік (використати день народження birthDate для обчислення віку)
  - Написати функцію що повератє список користувачів з України (номер телефону +380). 
  - Написати функцію що на основі даних усіх користувачів повератє масив штатів і їх поштових індексів у вигляді масиву обєктів [{"name": "AK", "postalCode": "99503"}]. Штати не повинні повторюватися. 
  - Запитати у користувача його вік, написати функція яка повератє список приблизних однолітків (з різницею у віці (age) меньше ніж 4 роки). Вивести їх імена. Якщо немає - вивести в консоль "Однолітків не знайдено."
  - Написати функцію що повератє середній вік всіх жінок ("gender": "female")
  - Написати функцію що повератє список чоловіків, молодше 45 років, які мають чорне волосся
  - Написати функцію що повератє список людей які навчалися у одному і тому самому університеті
  - Написати функцію що повератє найбільш поширений колір волося серед жінок
  - Написати функцію що повератє найбільш поширениу групу крові серед чоловіків
   */
